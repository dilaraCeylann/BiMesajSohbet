...
public class StatusActivity extends AppCompatActivity {
    ...
    private void ChangeProfileStatus(String new_status) {
        if(TextUtils.isEmpty(new_status)){
            Toast.makeText(this, "Lütfen durumunuzu yazınız.", Toast.LENGTH_SHORT).show();
        } else {
            loadingBar.setTitle("Durum güncelleniyor");
            loadingBar.setMessage("Lütfen güncellenirken bekleyiniz.");
            loadingBar.show();
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(StatusActivity.this, "Durum başarıyla güncellendi.", Toast.LENGTH_LONG).show();
                            } else {
                                Toast.makeText(StatusActivity.this, "Hata oldu...", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
        }
