...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        declineFriendRequestButton = findViewById(R.id.profile_decline_friend_request_btn);
        ...
        UsersReference.child(receiver_user_id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(ProfileActivity.this).load(image).placeholder(R.drawable.standart_insan).into(displayProfileImage);
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    if(dataSnapshot.hasChild(receiver_user_id)){
                                        ...
                                        if(req_type.equals("sent")){
                                            ...
                                            sendFriendRequestButton.setText("Arkadaşlık isteğini iptal et");
    ...
    private void AcceptFriendRequest() {
        ...
        final String saveCurrentDate = currentDate.format(AcceptDate.getTime());
